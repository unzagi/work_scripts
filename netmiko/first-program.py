...
from my_devices import cisco_ios
...
def remove_bgp_config(net_connect, cmd='no router bgp',
                      as_number=''):
...
def configure_bgp(net_connect, file_name='bgp_cisco_ios.txt'):
...
def main():
    ...
    for a_device in device_list:
        ...
        net_connect.enable()
        print("{}: {}".format(net_connect.device_type,
        ...
        #Check BGP configuration is gone
        if check_bgp(net_connect):
